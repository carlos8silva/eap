...
public class NTUtil extends UnitTester {
	...
	public void time_testMilliseconds() {
		...
		//long zero = -92233720368547L;
		//cal.setTimeInMillis(Long.MIN_VALUE);
		//System.out.println(Long.MIN_VALUE+" milliseconds: "+DateFormat.getDateTimeInstance().format(cal.getTime()));
		...
		// Time = 0:      -62135769600000
		// Time = 0 + 1s: -62135769599000
		// Time = 0 - 1s: -62135769541000
	...
	public void time_testDefaultDateFormat() throws Throwable {
		...
		// TODO if we parse with the default DF, we lose the milliseconds
		// Maybe we should implement a parse method for Time as well...
	...
	// TODO use test resources instead of system files... unless we want to suddenly crash the system
	...
	public void regexp_testPatterns() {
		...
		// 2) Emulate wildcard characters:
		String[] names = {
			"Carlos Silva", "Isabel Figueiredo", "João Madeira", "Darren King",
	...
	public void concurrency_testWait() {
		// TODO
		// One shared obj which has internal counter
		// Thread 1 gets current, increases, prints
		// Thread 2 from numbers 20 to 60 waits on Thread 1 to run
		// then it blocks and prints until number 80
		// After 80, both threads print concurrently
	}
